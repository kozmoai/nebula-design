  ...
  <ComponentPage title="Icons" :demos="[{ title: 'Icons' }]">
    <template #description>
      The following icons are a combination of <PLink to="https://heroicons.com/">
        Hero Icons
      </PLink> and custom icons added by Nebula.
    </template>
...
<script lang="ts" setup>
  ...
  import { HeroIcon, NebulaIcon } from '@/types'
  ...
  const nebulaIconKeys = Object.keys(nebulaIcons) as NebulaIcon[]
  const heroIconKeys = Object.keys(heroIcons) as HeroIcon[]
  const icons = [...nebulaIconKeys, ...heroIconKeys]
