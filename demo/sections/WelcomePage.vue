  ...
  <div class="welcome-page">
    ...
    <div class="welcome-page__content-container">
      <div class="welcome-page__content">
        <p-icon class="welcome-page__logo-icon" icon="Nebula" />
        <div class="welcome-page__intro">
          <p class="welcome-page__title">
            Nebula Design
          </p>
          <p class="welcome-page__description">
            Nebula Design is UI Component library built on Vue 3 and Typescript. Components are designed on top of Tailwind CSS, so each component is beautiful and responsive.
          </p>
        </div>
        <p-terminal class="welcome-page__terminal" command="npm i @kozmoai/nebula-design" />
        <div class="welcome-page__links">
          <a href="https://www.nebula.io/">
            <p-button icon="BookOpenIcon">
              Documentation
            </p-button>
          </a>
          <a href="https://github.com/kozmoai/nebula-design/" target="_blank">
